...
<nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <ul class="nav justify-content-end">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="insert_tdb.php">Tableau de bord</a>
                </li>
            </ul>
        </div>
</nav>
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                ...
                echo "<td class=\"align-middle\"><img class=\"thumbnail\"src=\"" . $row['image'] . "\" height='60px'\"\" width='70px'\"\">\n</td>";
                echo '<td><a class="btn btn-primary" type="submit" name="modifier" value="modifier" href="modifier.php?id='. $row['id'] .'" >modifier</a></td>';
                echo '<td><a class="btn btn-danger" type="submit" name="supprimer" value="supprimer" href="supprimer.php?id='. $row['id'] .'" >supprimer</a></td>';
