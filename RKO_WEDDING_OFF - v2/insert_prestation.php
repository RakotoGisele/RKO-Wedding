...
$sql = "INSERT INTO ajout_prestation (titre, description, image) VALUES ('$titre', '$description', '$image')";
if(mysqli_query($link, $sql)){
    echo "Prestation ajouté avec succès. <a href='tdb.php'>Afficher le tableau de bord</a>";
