...
$sql = "INSERT INTO ajout_coffret (titre, description, image) VALUES ('$titre', '$description', '$image')";
if(mysqli_query($link, $sql)){
    echo "Coffret ajouté avec succès. <a href='tdb.php'>Afficher le tableau de bord</a>";
